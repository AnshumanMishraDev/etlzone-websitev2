...
export const services: Service[] = [
  ...
  },
  {
    ...
    overviewDesc: "Data cleaning is the remediation of source data quality issues (duplicates, inconsistent formats, missing mandatory fields, and orphaned records) before extraction and load begin.",
    includes: [
  ...
  },
  {
    ...
    includes: [
      ...
      { title: "Mapping Documentation", desc: "A signed-off mapping document your build team can work from directly, with no ambiguity or assumptions." },
    ],
  ...
  },
  {
    ...
    includes: [
      { title: "Record Count Reconciliation", desc: "Confirming every source record has a corresponding target record, with no silent drops during load." },
